...
# ------------------------------------------------------------------------------
# TODOne: 2.          With your instructor, READ THE INSTRUCTIONS in
# TODOne (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
# TODOne (continued): Then implement a class called   Point that has NO METHODS
# TODOne (continued)  yet, just the lines that start the definition of any class:
#
...
class Point(object):
    ...
    def closer_to(self, p2, p3):
        distance_from_p2 = self.get_distance_from(p2)
        distance_from_p3 = self.get_distance_from(p3)
        if distance_from_p2 >= distance_from_p3:
            return p2
        else:
            return p3
...
def run_test_repr():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 4.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_clone():
   ...
   """
    # --------------------------------------------------------------------------
    # TODOne: 5.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # --------------------------------------------------------------------------
    # TODOne: 7.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 8.  Follow the same instructions as in _TODO_ 3 above,
    #    but for the  get_number_of_moves_made  method specified above.
    # TODOne (continued):  HINT: What must a Point REMEMBER for this method?
    # --------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
...
def run_test_get_distance_from():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 9.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 10.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 11.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_closer_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOne: 12.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # --------------------------------------------------------------------------
    # TODOnw: 13.  Follow the same instructions as in TO-DO 3 above,
